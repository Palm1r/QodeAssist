...
Providers::ProviderID GoogleAIProvider::providerID() const
{
    return Providers::ProviderID::GoogleAI;
}

Providers::ProviderCapabilities GoogleAIProvider::capabilities() const
{
    ...
    const QUrl &url, const QJsonObject &payload, const QString &endpoint)
{
    ...
    return Providers::Provider::sendRequest(url, cleaned, endpoint);
}
