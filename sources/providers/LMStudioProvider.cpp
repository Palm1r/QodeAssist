...
Providers::ProviderID LMStudioProvider::providerID() const
{
    return Providers::ProviderID::LMStudio;
}

Providers::ProviderCapabilities LMStudioProvider::capabilities() const
{
...
{
    return Providers::Provider::sendRequest(
