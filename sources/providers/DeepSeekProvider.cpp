...
Providers::ProviderID DeepSeekProvider::providerID() const
{
    return Providers::ProviderID::DeepSeek;
}

Providers::ProviderCapabilities DeepSeekProvider::capabilities() const
{
