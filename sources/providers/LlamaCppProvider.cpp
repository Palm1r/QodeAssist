...
Providers::ProviderID LlamaCppProvider::providerID() const
{
    return Providers::ProviderID::LlamaCpp;
}

Providers::ProviderCapabilities LlamaCppProvider::capabilities() const
{
