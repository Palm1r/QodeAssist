...
QStringList PromptTemplateManager::getFimTemplatesForProvider(Providers::ProviderID id)
{
...
QStringList PromptTemplateManager::getChatTemplatesForProvider(Providers::ProviderID id)
{
    QStringList templateList;
